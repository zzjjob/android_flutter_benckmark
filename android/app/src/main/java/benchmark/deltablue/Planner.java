...
public final class Planner {
  ...
  public Plan extractPlanFromConstraints(@NonNull final ArrayList<? extends Constraint> constraints) {
    final LinkedList<Constraint> sources = new LinkedList();
  ...
  public boolean addPropagate(@NonNull final Constraint c, final int mark) {
    final LinkedList<Constraint> todo = new LinkedList();
    todo.add(c);
  ...
  ArrayList<Constraint> removePropagateFrom(@NonNull final Variable out) {
    ...
    out.stay = true;
    final ArrayList<Constraint> unsatisfied = new ArrayList();
    final LinkedList<Variable> todo = new LinkedList();
    todo.add(out);
    while(!todo.isEmpty()) {
