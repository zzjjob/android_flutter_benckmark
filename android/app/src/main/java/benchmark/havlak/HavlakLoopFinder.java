...
public final class HavlakLoopFinder {
  ...
  public int findLoops() {
    ...
    final ArrayList<ArrayList<Integer>> nonBackPreds = new ArrayList(size);
    final ArrayList<ArrayList<Integer>> backPreds = new ArrayList(size);
    final ArrayList<Integer> number = new ArrayList(size);
    final ArrayList<Integer> header = new ArrayList(size);
    final ArrayList<Integer> types = new ArrayList(size);
    final ArrayList<Integer> last = new ArrayList(size);
    final ArrayList<UnionFindNode> nodes = new ArrayList(size);

    for(int i = 0; i < size; ++i) {
      nonBackPreds.add(new ArrayList<Integer>());
    ...
    for (int w = size-1; w >=0; --w) {
      ...
      final ArrayList<UnionFindNode> nodePool = new ArrayList();
      ...
      //
      final LinkedList<UnionFindNode> workList = new LinkedList();
